...
public AdapterAllCategoriesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.categories_card_design1, parent, false);
...
public void onBindViewHolder(@NonNull AdapterAllCategoriesViewHolder holder, int position) {
        ...
        holder.imageView.setImageResource(CategoriesHelperClass.getImages());
        holder.textView.setText(CategoriesHelperClass.getTitles());
        holder.relativeLayout.setBackground(Drawable.createFromPath(CategoriesHelperClass.getGradien()));
        }
@Override
